...
from mlpipeline.models.segmentation.transbts.Transformer import TransformerModel
from mlpipeline.models.segmentation.transbts.PositionalEncoding import FixedPositionalEncoding,LearnedPositionalEncoding
from mlpipeline.models.segmentation.transbts.Unet_skipconnection import Unet
...
class TransformerBTS(nn.Module):
    def __init__(
        ...
        self.num_patches = int((img_dim // patch_dim) ** 2) * int(img_depth // patch_dim)
    ...
    def _reshape_output(self, x):
        x = x.view(
            ...
            int(self.img_dim / self.patch_dim),
            int(self.img_depth / self.patch_dim),
            self.embedding_dim,
        )
